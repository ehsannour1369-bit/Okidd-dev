...
export default function AdminStudents() {
  ...
  const createMut = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ["users", "student", selectedSchoolId] }); setShowModal(false); setForm({ name: "", email: "", password: "", gender: "male", nationalId: "" }); },
  });
  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "#8b5cf6", fontSize: 14, marginTop: 4 }}>مدیریت دانش‌آموزان همه مدارس</p>
      </div>
