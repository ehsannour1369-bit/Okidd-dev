      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {teachers.map((t: any) => (
          <div key={t.id} style={{ background: "rgba(255,255,255,0.82)", border: "1px solid rgba(139,92,246,0.2)", borderRadius: 14, padding: 20, transition: "all 0.2s ease" }}
            onMouseOver={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(99,102,241,0.45)"; }}
            onMouseOut={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(99,102,241,0.15)"; }}>
