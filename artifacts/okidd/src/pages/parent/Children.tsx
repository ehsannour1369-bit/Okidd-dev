...
const FEMALE_THEME = { p: "#b5607a", pD: "#8f4860", s: "#b87898", sD: "#9a6080", text: "#2d1820", text2: "#6b3a50", bg: "linear-gradient(160deg,#fdfafb 0%,#faf5f8 42%,#fdf8fa 100%)", b1: "rgba(181,96,122,0.07)", b2: "rgba(184,120,152,0.05)" };
