...
const FEMALE_THEME = { p: "#d4547a", pD: "#ae3a5e", s: "#d870a2", sD: "#b5538a", text: "#2d1820", text2: "#7a3552", bg: "linear-gradient(160deg,#fef5f7 0%,#fceef5 42%,#fdf6f9 100%)", b1: "rgba(212,84,122,0.14)", b2: "rgba(216,112,162,0.10)", b3: "rgba(212,84,122,0.07)" };
