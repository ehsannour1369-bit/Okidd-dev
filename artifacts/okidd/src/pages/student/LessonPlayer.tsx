...
export default function LessonPlayer() {
  ...
  if (content.length === 0) return (
    <div style={{ ...pageWrap }}>
      <div style={{ width: "100%", maxWidth: 480, height: "100%", display: "flex", flexDirection: "column", padding: "16px 14px", gap: 12, boxSizing: "border-box" }}>
        <Header />
  ...
  return (
    <div style={{ ...pageWrap }}>
      <div style={{ width: "100%", maxWidth: 480, height: "100%", display: "flex", flexDirection: "column", padding: "14px 14px 16px", gap: 10, boxSizing: "border-box" }}>
